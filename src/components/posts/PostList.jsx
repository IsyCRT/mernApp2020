...
class PostList extends Component {
  ...
  getPosts() {
      getAllPosts().then((posts) => {
        this.setState({
          posts // asi pq la variable se llaman iguales sino se asigna, ver video
        });
      });
    }
  componentDidMount() {
  ...
  render() {
      return (
        // el alert es un componente igual q badge de react de su sitio
        // map permite iterear y tiene toda la informacion del post, post es posteo
        <div>
